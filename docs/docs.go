...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin-api/fire-alarm": {
            "get": {
                ...
                "description": "Returns whether a fire alarm is running, when it started, how long it lasts and\nhow much of that window is left. Expiration is evaluated before the status is\nreturned, so an elapsed alarm is never reported as active.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_http_controller_adminapi.FireAlarmResponse"
                        }
                    }
                }
            },
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Fire alarm request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_controller_adminapi.SetFireAlarmRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_http_controller_adminapi.FireAlarmResponse": {
            "type": "object",
            "properties": {
                "default_duration": {
                    "type": "integer"
        ...
        "internal_http_controller_adminapi.SetFireAlarmRequest": {
            "type": "object",
            "required": [
                "enabled"
            ],
